...
Install: npx skills add remotion-dev/skills and @remotion/rounded-text-box @remotion/layout-utils @remotion/captions @remotion/google-fonts @remotion/media
...
See CURSOR_FOLLOWUP.md for the full punch list.

...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-glossary-encode-master/2026-09-21";
const PRIOR =
...
test("full-set glossary encode master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine glossary encode master dest reaudit 2026-09-21/);
  assert.match(full, /247890d0529b635d8ad39317825c760fe76fe134274e2149e4ccbe9bcb1af32c/);
  ...
  assert.match(src("antagonist-glossary-encode-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-glossary-encode-master.md"), /EDU-S02: PASS/);
  assert.match(
    src("antagonist-glossary-encode-master.md"),
    /247890d0529b635d8ad39317825c760fe76fe134274e2149e4ccbe9bcb1af32c/,
  );
  assert.match(
    src("antagonist-glossary-encode-master.md"),
    /PR 137 merge `a5c954491dc32a9e8ee88f4abe2e1fc90bdf2307`/,
  );
  assert.match(wave5, /## LessonSpine glossary encode master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 137 merge `a5c9544`/);
  ...
  assert.match(campus, /PR 137 merge `a5c9544`/);
  assert.match(campus, /LessonSpine glossary encode master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /247890d0529b635d8ad39317825c760fe76fe134274e2149e4ccbe9bcb1af32c/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-glossary-encode-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked glossary encode master dest and audit stills exist; priors untouched", () => {

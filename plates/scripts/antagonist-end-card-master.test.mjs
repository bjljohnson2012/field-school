...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-end-card-master/2026-09-20";
const PRIOR =
...
test("full-set end-card master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine end-card master dest reaudit 2026-09-20/);
  assert.match(full, /073e1e3b18f3c6f2bc1590991d5bee4059c33487a19ff083c55927480d7a7693/);
  ...
  assert.match(src("antagonist-end-card-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-end-card-master.md"), /EDU-S02: PASS/);
  assert.match(src("antagonist-end-card-master.md"), /073e1e3b18f3c6f2bc1590991d5bee4059c33487a19ff083c55927480d7a7693/);
  assert.match(src("antagonist-end-card-master.md"), /PR 119 merge `9f762bf0fec4a7df1b4cd3370071c8246122c86b`/);
  assert.match(wave5, /## LessonSpine end-card master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 119 merge `9f762bf`/);
  ...
  assert.match(campus, /PR 119 merge `9f762bf`/);
  assert.match(campus, /LessonSpine end-card master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /073e1e3b18f3c6f2bc1590991d5bee4059c33487a19ff083c55927480d7a7693/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-end-card-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked end-card master dest and audit stills exist; priors untouched", () => {

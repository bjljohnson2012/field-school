...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-typecard-objectiveslate-master/2026-09-20";
const SLATE =
...
test("full-set typecard-objectiveslate master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine typecard-objectiveslate master dest reaudit 2026-09-20/);
  assert.match(full, /3f42545633b331c184febe17349c9d3162295c97dabeec5458bebd2007aa95e5/);
  ...
  assert.match(src("antagonist-typecard-objectiveslate-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-typecard-objectiveslate-master.md"), /EDU-S02: PASS/);
  assert.match(src("antagonist-typecard-objectiveslate-master.md"), /3f42545633b331c184febe17349c9d3162295c97dabeec5458bebd2007aa95e5/);
  assert.match(src("antagonist-typecard-objectiveslate-master.md"), /PR 99 merge `7186244f76d15f6c3fdeb4e91ed7b889ac0228fb`/);
  assert.match(wave5, /## LessonSpine typecard-objectiveslate master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 99 merge `7186244`/);
  ...
  assert.match(campus, /PR 99 merge `7186244`/);
  assert.match(campus, /LessonSpine typecard-objectiveslate master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /3f42545633b331c184febe17349c9d3162295c97dabeec5458bebd2007aa95e5/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-typecard-objectiveslate-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked typecard-objectiveslate master dest and audit stills exist; priors untouched", () => {

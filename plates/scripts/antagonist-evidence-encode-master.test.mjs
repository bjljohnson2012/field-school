...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-evidence-encode-master/2026-09-21";
const PRIOR =
...
test("full-set evidence encode master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine evidence encode master dest reaudit 2026-09-21/);
  assert.match(full, /5d0499f6cbff19149ce0b5da3c615a1ca0ab26fbbece2d9e26da0e78dd367c4b/);
  ...
  assert.match(src("antagonist-evidence-encode-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-evidence-encode-master.md"), /EDU-S02: PASS/);
  assert.match(
    src("antagonist-evidence-encode-master.md"),
    /5d0499f6cbff19149ce0b5da3c615a1ca0ab26fbbece2d9e26da0e78dd367c4b/,
  );
  assert.match(
    src("antagonist-evidence-encode-master.md"),
    /PR 178 merge `053c4cee5934b02b25cbe6c2092033d614788c38`/,
  );
  assert.match(wave5, /## LessonSpine evidence encode master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 178 merge `053c4ce`/);
  ...
  assert.match(campus, /PR 178 merge `053c4ce`/);
  assert.match(campus, /LessonSpine evidence encode master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /5d0499f6cbff19149ce0b5da3c615a1ca0ab26fbbece2d9e26da0e78dd367c4b/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-evidence-encode-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked evidence encode master dest and audit stills exist; priors untouched", () => {

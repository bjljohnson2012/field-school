...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-practice-encode-master/2026-09-21";
const PRIOR =
...
test("full-set practice encode master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine practice encode master dest reaudit 2026-09-21/);
  assert.match(full, /8c953707401f835551ceec5d96c090b133cd619b41c4b7ff543b1637edc44dbf/);
  ...
  assert.match(src("antagonist-practice-encode-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-practice-encode-master.md"), /EDU-S02: PASS/);
  assert.match(src("antagonist-practice-encode-master.md"), /8c953707401f835551ceec5d96c090b133cd619b41c4b7ff543b1637edc44dbf/);
  assert.match(src("antagonist-practice-encode-master.md"), /PR 122 merge `c4474d1789489b5bb18004fe70338ec8ccb92fd4`/);
  assert.match(wave5, /## LessonSpine practice encode master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 122 merge `c4474d1`/);
  ...
  assert.match(campus, /PR 122 merge `c4474d1`/);
  assert.match(campus, /LessonSpine practice encode master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /8c953707401f835551ceec5d96c090b133cd619b41c4b7ff543b1637edc44dbf/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-practice-encode-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked practice encode master dest and audit stills exist; priors untouched", () => {
  ...
  for (const name of [
    ...
    "PracticeCardDemo-f0.png",
    "PracticeCardDemo-f60.png",
  ]) {

...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-spectrum-encode-master/2026-09-21";
const PRIOR =
...
test("full-set spectrum encode master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine spectrum encode master dest reaudit 2026-09-21/);
  assert.match(full, /496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0/);
  ...
  assert.match(src("antagonist-spectrum-encode-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-spectrum-encode-master.md"), /EDU-S02: PASS/);
  assert.match(
    src("antagonist-spectrum-encode-master.md"),
    /496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0/,
  );
  assert.match(
    src("antagonist-spectrum-encode-master.md"),
    /PR 169 merge `6b98e60673a3d665fda938c0f8d22896de8d99df`/,
  );
  assert.match(wave5, /## LessonSpine spectrum encode master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 169 merge `6b98e60`/);
  ...
  assert.match(campus, /PR 169 merge `6b98e60`/);
  assert.match(campus, /LessonSpine spectrum encode master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-spectrum-encode-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked spectrum encode master dest and audit stills exist; priors untouched", () => {

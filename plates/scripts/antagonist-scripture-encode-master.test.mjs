...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-scripture-encode-master/2026-09-21";
const PRIOR =
...
test("full-set scripture encode master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine scripture encode master dest reaudit 2026-09-21/);
  assert.match(full, /cb3a672da3871428548f2e6ec69da03b9c1d2e425058a1b4b856d928a6e43a79/);
  ...
  assert.match(src("antagonist-scripture-encode-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-scripture-encode-master.md"), /EDU-S02: PASS/);
  assert.match(
    src("antagonist-scripture-encode-master.md"),
    /cb3a672da3871428548f2e6ec69da03b9c1d2e425058a1b4b856d928a6e43a79/,
  );
  assert.match(
    src("antagonist-scripture-encode-master.md"),
    /PR 128 merge `94c848e53a5c4cfa07e735b3fc24869d5a31ffcb`/,
  );
  assert.match(wave5, /## LessonSpine scripture encode master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 128 merge `94c848e`/);
  ...
  assert.match(campus, /PR 128 merge `94c848e`/);
  assert.match(campus, /LessonSpine scripture encode master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /cb3a672da3871428548f2e6ec69da03b9c1d2e425058a1b4b856d928a6e43a79/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-scripture-encode-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked scripture encode master dest and audit stills exist; priors untouched", () => {

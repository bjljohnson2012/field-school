...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-key-claim-encode-master/2026-09-21";
const PRIOR =
...
test("full-set key-claim encode master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine key-claim encode master dest reaudit 2026-09-21/);
  assert.match(full, /16f516640c5cac4609862ae2436eb37dd118e56bc6633e3dd10d76290a588606/);
  ...
  assert.match(src("antagonist-key-claim-encode-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-key-claim-encode-master.md"), /EDU-S02: PASS/);
  assert.match(src("antagonist-key-claim-encode-master.md"), /16f516640c5cac4609862ae2436eb37dd118e56bc6633e3dd10d76290a588606/);
  assert.match(src("antagonist-key-claim-encode-master.md"), /PR 125 merge `7f53d60bd5acfb0750a58bd54e3aff0eb3b227e8`/);
  assert.match(wave5, /## LessonSpine key-claim encode master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 125 merge `7f53d60`/);
  ...
  assert.match(campus, /PR 125 merge `7f53d60`/);
  assert.match(campus, /LessonSpine key-claim encode master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /16f516640c5cac4609862ae2436eb37dd118e56bc6633e3dd10d76290a588606/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-key-claim-encode-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked key-claim encode master dest and audit stills exist; priors untouched", () => {

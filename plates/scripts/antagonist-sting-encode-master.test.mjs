...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-sting-encode-master/2026-09-21";
const PRIOR =
...
test("full-set sting encode master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine sting encode master dest reaudit 2026-09-21/);
  assert.match(full, /325a41e775821c8576e14038d2076ee639d48a0fc29b3f84b223f4af9390f204/);
  ...
  assert.match(src("antagonist-sting-encode-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-sting-encode-master.md"), /EDU-S02: PASS/);
  assert.match(
    src("antagonist-sting-encode-master.md"),
    /325a41e775821c8576e14038d2076ee639d48a0fc29b3f84b223f4af9390f204/,
  );
  assert.match(
    src("antagonist-sting-encode-master.md"),
    /PR 142 merge `82192643d93aa3e103759ca2bbce7bc0b4a2d985`/,
  );
  assert.match(wave5, /## LessonSpine sting encode master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 142 merge `8219264`/);
  ...
  assert.match(campus, /PR 142 merge `8219264`/);
  assert.match(campus, /LessonSpine sting encode master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /325a41e775821c8576e14038d2076ee639d48a0fc29b3f84b223f4af9390f204/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-sting-encode-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked sting encode master dest and audit stills exist; priors untouched", () => {

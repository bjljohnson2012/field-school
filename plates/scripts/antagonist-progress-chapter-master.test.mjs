...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-progress-chapter-master/2026-09-20";
const PRIOR =
...
test("full-set progress-chapter master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine progress-chapter master dest reaudit 2026-09-20/);
  assert.match(full, /a11e31a38774266b80a8f64e088ff4eb0b59d80bc7b710e9240b6ee076e61ce7/);
  ...
  assert.match(src("antagonist-progress-chapter-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-progress-chapter-master.md"), /EDU-S02: PASS/);
  assert.match(src("antagonist-progress-chapter-master.md"), /a11e31a38774266b80a8f64e088ff4eb0b59d80bc7b710e9240b6ee076e61ce7/);
  assert.match(src("antagonist-progress-chapter-master.md"), /PR 105 merge `9052d6a8346525a854d556d31fccb70ed52c6716`/);
  assert.match(wave5, /## LessonSpine progress-chapter master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 105 merge `9052d6a`/);
  ...
  assert.match(campus, /PR 105 merge `9052d6a`/);
  assert.match(campus, /LessonSpine progress-chapter master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /a11e31a38774266b80a8f64e088ff4eb0b59d80bc7b710e9240b6ee076e61ce7/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-progress-chapter-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked progress-chapter master dest and audit stills exist; priors untouched", () => {
  ...
  for (const name of [
    ...
    "Opener-f30.png",
    "RecapCard-f144.png",
    "ProgressRailDemo-f60.png",
    "ChapterChipDemo-f60.png",
  ]) {

...
const STILLS = "/opt/cursor/artifacts/remotion-antagonist-timeline-encode-master/2026-09-21";
const PRIOR =
...
test("full-set timeline encode master reaudit is dated PASS with hold_cleaning", () => {
  ...
  assert.match(full, /## LessonSpine timeline encode master dest reaudit 2026-09-21/);
  assert.match(full, /2b2dab3e239656e122d4dda3199e294ec836351a83120efaefe2aa54e4b8c068/);
  ...
  assert.match(src("antagonist-timeline-encode-master.md"), /EDU-S01: PASS/);
  assert.match(src("antagonist-timeline-encode-master.md"), /EDU-S02: PASS/);
  assert.match(
    src("antagonist-timeline-encode-master.md"),
    /2b2dab3e239656e122d4dda3199e294ec836351a83120efaefe2aa54e4b8c068/,
  );
  assert.match(
    src("antagonist-timeline-encode-master.md"),
    /PR 163 merge `9225118420f3682afe18e4f47731d2fba37f5204`/,
  );
  assert.match(wave5, /## LessonSpine timeline encode master dest reaudit \(PASS\)/);
  assert.match(wave5, /PR 163 merge `9225118`/);
  ...
  assert.match(campus, /PR 163 merge `9225118`/);
  assert.match(campus, /LessonSpine timeline encode master dest reaudit \*\*PASS\*\*/);
  assert.match(campus, /2b2dab3e239656e122d4dda3199e294ec836351a83120efaefe2aa54e4b8c068/);
  assert.match(campus, /\*\*CLOSED\*\*, \*\*0\/8\*\*/);
  assert.match(src("README.md"), /antagonist-timeline-encode-master\.md/);
  assert.doesNotMatch(wave5, /8\/8 PASS|launch OPEN/i);
});

test("locked timeline encode master dest and audit stills exist; priors untouched", () => {

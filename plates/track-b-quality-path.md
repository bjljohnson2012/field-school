...
Proof: `node --test scripts/track-b-export-ready.test.mjs scripts/track-b-master.test.mjs scripts/track-b-plates.test.mjs scripts/track-b-quality-path.test.mjs` from `plates/`.

# Independent Antagonist v2 — TalkingHead slate

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-20**. TalkingHeadCard slate-beat soft polish. Kicker “Slate” plus Title last-word gold `#C4A35A` tick (`Keyword`) on fixture “Docked, not full-bleed”. Karaoke already gold-ticks “full-bleed” 1100–1800ms (plate f45 / spine f345). No Cap take. Plate-level stills only.
...
After PR 91 merge `73f540186ab6a444c5d69e026c69025412406a88`. Locked master dest `/opt/cursor/artifacts/lesson-spine-edu-s02-encode/2026-09-20/LessonSpine.mp4` sha256 `eaf6f84a5363b23f512c0c07f82f90464f11b8c3b57d69a0fa23af951d9798e8` **untouched** (plate-level stills only). LowerThird stays name/role. OverlayLock 30px / `0.02em` / `0.2em` nowrap. Checklist `hold_cleaning: true`. `--flip` refused.

## SOFT notes only

- `EDU-S01` — **PASS** on the locked master
- `EDU-S02` — **PASS** gold keyword tick on TalkingHead Title last word + kicker “Slate”

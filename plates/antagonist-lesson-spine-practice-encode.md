# Independent Antagonist v2 — LessonSpine PracticeCard encode

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-21**. New dated LessonSpine encode after PR 121 merge `e36897dc5c51a44d7735c4612d3b61b83194bb1d`. Bundles PracticeCard application / try-this onto the locked EndCard master stack. No Cap take. PRs 85–121 harvested.
...
This dest is now an archived prior (file **untouched**). Current master dest is key-claim-encode.

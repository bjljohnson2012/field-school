# Independent Antagonist v2 — LessonSpine EDU-S01 encode

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-20**. New dated LessonSpine encode after PR 85 merge `a97167a0fa75d87ddea95c3397917aae5039f562`. EDU-S01 Opener / Recap objective slate is in the mux. No Cap take.
...
ffprobe: h264 1920×1080@30 duration 41.000s, video only. Sting still shows “You will be able to” + `draw one idea per beat`. Recap still returns the same objective (signaling, not a fourth numbered claim). TypeCard cream + gold 6px rail. OverlayLock 30px + seal `1576,24`. Karaoke gold `#C4A35A`. Letterbox ink bars. Head docked. Checklist exit 0. `--flip` refused. Typecard dest **untouched** (`27cc5bf3e37f8496257b4efb0f8b1ef2938af35a287aa1530f00db60d984a9a0`). Other priors untouched (`9f89f9a9…` / `028d16e4…` / `a5d08284…` / `ec88d257…`).
...
This dest is now an archived prior (file **untouched**). Current master dest is edu-s02-encode.

# Independent Antagonist v2 — CaptionDensity

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-20**. CaptionDensity soft craft beat. Karaoke line packing on `CaptionsBand` (`CAPTION_DENSITY_WORDS = 6`). Craft beat on `CaptionDensityDemo`. Caption density path only. No Cap take. Plate-level stills only.
...
After PR 110 merge `380b36d41922951e04e0d96f1400dff1ced036e3`. Locked master dest `/opt/cursor/artifacts/lesson-spine-lower-callout-encode/2026-09-20/LessonSpine.mp4` sha256 `68b8378a47d9eb57ed4b41f35bc2bf4ed6fd01a0694fca28c0a5ea90101fee92` **untouched** (plate-level stills only). OverlayLock 30px / `0.02em` / `0.2em` nowrap. Checklist `hold_cleaning: true`. `--flip` refused.

## SOFT notes only

- `EDU-S01` — **PASS** on the locked master
- `EDU-S02` — **PASS** karaoke gold ticks unchanged; packing shows the active 6-word line

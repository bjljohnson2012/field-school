# Independent Antagonist v2 — TransitionLuma

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-20**. TransitionLuma soft craft beat. Beat-to-beat wipe (`TRANSITION_LUMA_FRAMES = 18` cream luma + gold 6px leading edge). Craft beat on `TransitionLumaDemo`. TransitionLuma path only. No Cap take. Plate-level stills only.
...
After PR 114 merge `c2a63b7997773147bb0f50bd163a675fc942f25c`. Locked master dest `/opt/cursor/artifacts/lesson-spine-caption-overlay-encode/2026-09-20/LessonSpine.mp4` sha256 `5b229fee3254426ba8b6dca0c7af23f2270b485b7b62f296b5ae6a31b4d5c61c` **untouched** (plate-level stills only). Checklist `hold_cleaning: true`. `--flip` refused.

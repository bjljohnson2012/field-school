# Independent Antagonist v2 — spectrum encode master dest

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-21**. Soft re-score of the locked SpectrumBar LessonSpine master plus SpectrumBar plates. After PR 169 merge `6b98e60673a3d665fda938c0f8d22896de8d99df` / tip `3faad53b1243a809178a753a76b1291210b52d66`. No Cap take. No new encode this round.
...
Next unattended Remotion plate craft (not Cap-blocked): `remotion-threshold-card` — cutoff mark on a range, distinct from SpectrumBar continuum. After SpectrumBar, before PracticeCard.

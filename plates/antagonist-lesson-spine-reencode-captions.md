# Independent Antagonist v2 — LessonSpine re-encode (captions + lower third)
...
auto_flip: false
escalate: false
rendering: /opt/cursor/artifacts/lesson-spine-reencode-captions/2026-09-19/LessonSpine.mp4
...
Slate uses `LowerThird` name/role + `CaptionsBand` (via `Karaoke`). Encode via `render-plate.mjs` exit 0. ffprobe: h264 1920×1080@30 duration 41.000s. Checklist exit 0. Prior encode dest untouched (`a5d08284…`). No Cap A-roll. No Just / Aug 30 overwrite.

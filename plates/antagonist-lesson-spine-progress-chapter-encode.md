# Independent Antagonist v2 — LessonSpine ProgressRail + ChapterChip encode

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-20**. New dated LessonSpine encode after PR 104 merge `0dab60b9e62ff24e093cea43d8d2ce3a31488fc5`. Bundles ProgressRail ticks + ChapterChip labels + DefinitionBoard slate + AudioBed unmute onto the locked slate stack. No Cap take. PRs 85–104 harvested.
...
ffprobe: h264 1920×1080@30 duration 41.000s, video only. Sting still gold-ticks “Things” + claim “docked.” + ProgressRail sting + ChapterChip “Sting”. Slate still gold-ticks “full-bleed” with kicker “Slate” + claim “left.” + ChapterChip “Slate”. Objective still gold-ticks “motion” (DefinitionBoard) + ChapterChip “Objective”. Recap still gold-ticks “card” with kicker “Recap” + ChapterChip “Recap”. Next-up still shows kicker “Next up” + gold “draw?” + ChapterChip “Next up”. TypeCard cream + gold 6px rail. OverlayLock 30px + seal `1576,24`. Karaoke gold `#C4A35A`. Letterbox ink bars. AudioBed unmuted volume 0. Head docked. Checklist exit 0. `--flip` refused. Typecard-objectiveslate dest **untouched** (`3f42545633b331c184febe17349c9d3162295c97dabeec5458bebd2007aa95e5`). Other priors untouched (`d0a09896…` / `eaf6f84a…` / `cab8bd91…` / `27cc5bf3…` / `9f89f9a9…` / `028d16e4…` / `a5d08284…` / `ec88d257…`).

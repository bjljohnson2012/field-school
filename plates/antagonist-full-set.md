...
- [antagonist-lesson-spine-progress-chapter-encode.md](./antagonist-lesson-spine-progress-chapter-encode.md) — LessonSpine ProgressRail + ChapterChip encode (archived prior)
- [antagonist-lesson-spine-lower-callout-encode.md](./antagonist-lesson-spine-lower-callout-encode.md) — LessonSpine LowerThird + CalloutCard encode (archived prior)
- [antagonist-lesson-spine-caption-overlay-encode.md](./antagonist-lesson-spine-caption-overlay-encode.md) — LessonSpine CaptionDensity + OverlayLock encode (archived prior)
...
- [antagonist-lesson-spine-key-claim-encode.md](./antagonist-lesson-spine-key-claim-encode.md) — LessonSpine KeyClaim encode (archived prior)
- [antagonist-lesson-spine-scripture-encode.md](./antagonist-lesson-spine-scripture-encode.md) — LessonSpine ScriptureCard encode (archived prior)
...
- [antagonist-evidence-encode-master.md](./antagonist-evidence-encode-master.md) — LessonSpine evidence encode master dest reaudit 2026-09-21
- [antagonist-analogy-encode-master.md](./antagonist-analogy-encode-master.md) — LessonSpine analogy encode master dest reaudit 2026-09-21
- [antagonist-counterexample-encode-master.md](./antagonist-counterexample-encode-master.md) — LessonSpine counterexample encode master dest reaudit 2026-09-21
...
- [antagonist-transition-luma-master.md](./antagonist-transition-luma-master.md) — LessonSpine transition-luma master dest reaudit
- [antagonist-end-card-master.md](./antagonist-end-card-master.md) — LessonSpine end-card master dest reaudit
...
| `/opt/cursor/artifacts/lesson-spine-progress-chapter-encode/2026-09-20/LessonSpine.mp4` | `a11e31a38774266b80a8f64e088ff4eb0b59d80bc7b710e9240b6ee076e61ce7` | ProgressRail + ChapterChip — archived prior |
| `/opt/cursor/artifacts/lesson-spine-lower-callout-encode/2026-09-20/LessonSpine.mp4` | `68b8378a47d9eb57ed4b41f35bc2bf4ed6fd01a0694fca28c0a5ea90101fee92` | LowerThird + CalloutCard — archived prior |
| `/opt/cursor/artifacts/lesson-spine-caption-overlay-encode/2026-09-20/LessonSpine.mp4` | `5b229fee3254426ba8b6dca0c7af23f2270b485b7b62f296b5ae6a31b4d5c61c` | CaptionDensity + OverlayLock — archived prior |
| `/opt/cursor/artifacts/lesson-spine-transition-luma-encode/2026-09-20/LessonSpine.mp4` | `f631402a6dfbb2ca2218ea9617c7b2af527eb7e88f8df5547dc6584c9ef5a96e` | TransitionLuma — archived prior |
| `/opt/cursor/artifacts/lesson-spine-end-card-encode/2026-09-20/LessonSpine.mp4` | `073e1e3b18f3c6f2bc1590991d5bee4059c33487a19ff083c55927480d7a7693` | EndCard — archived prior |
| `/opt/cursor/artifacts/lesson-spine-practice-encode/2026-09-21/LessonSpine.mp4` | `8c953707401f835551ceec5d96c090b133cd619b41c4b7ff543b1637edc44dbf` | PracticeCard — archived prior |
| `/opt/cursor/artifacts/lesson-spine-key-claim-encode/2026-09-21/LessonSpine.mp4` | `16f516640c5cac4609862ae2436eb37dd118e56bc6633e3dd10d76290a588606` | KeyClaim — archived prior |
| `/opt/cursor/artifacts/lesson-spine-scripture-encode/2026-09-21/LessonSpine.mp4` | `cb3a672da3871428548f2e6ec69da03b9c1d2e425058a1b4b856d928a6e43a79` | ScriptureCard — archived prior |
...
## LessonSpine lower-callout encode 2026-09-20

Dated **2026-09-20**. New dated dest `/opt/cursor/artifacts/lesson-spine-lower-callout-encode/2026-09-20/LessonSpine.mp4` sha256 `68b8378a47d9eb57ed4b41f35bc2bf4ed6fd01a0694fca28c0a5ea90101fee92`. Archived prior dest (file **untouched**). Progress-chapter dest `a11e31a38774266b80a8f64e088ff4eb0b59d80bc7b710e9240b6ee076e61ce7` archived prior, **untouched**. PRs 85–108. After PR 108 merge `f15642fbbc2aee23c1a10dc6b3066e3405283186`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-lower-callout-encode/2026-09-20/`. Checklist `hold_cleaning: true`. `--flip` refused.

```
verdict: PASS
dated: 2026-09-20
rendering: /opt/cursor/artifacts/lesson-spine-lower-callout-encode/2026-09-20/LessonSpine.mp4
sha256: 68b8378a47d9eb57ed4b41f35bc2bf4ed6fd01a0694fca28c0a5ea90101fee92
stills: /opt/cursor/artifacts/remotion-lesson-spine-lower-callout-encode/2026-09-20/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine lower-callout master dest reaudit 2026-09-20

Dated **2026-09-20** Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-lower-callout-encode/2026-09-20/LessonSpine.mp4` sha256 `68b8378a47d9eb57ed4b41f35bc2bf4ed6fd01a0694fca28c0a5ea90101fee92` plus LowerThird/CalloutCard plates. After PR 109 merge `7bb2ac69cbc17c320236cb9bdbdb00e7678e3ce2`. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Progress-chapter dest **untouched** (`a11e31a38774266b80a8f64e088ff4eb0b59d80bc7b710e9240b6ee076e61ce7`). Locked master dest **untouched**.
...
rendering: /opt/cursor/artifacts/lesson-spine-lower-callout-encode/2026-09-20/LessonSpine.mp4
sha256: 68b8378a47d9eb57ed4b41f35bc2bf4ed6fd01a0694fca28c0a5ea90101fee92
stills: /opt/cursor/artifacts/remotion-antagonist-lower-callout-master/2026-09-20/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine caption-overlay encode 2026-09-20

Dated **2026-09-20**. New dated dest `/opt/cursor/artifacts/lesson-spine-caption-overlay-encode/2026-09-20/LessonSpine.mp4` sha256 `5b229fee3254426ba8b6dca0c7af23f2270b485b7b62f296b5ae6a31b4d5c61c`. Archived prior dest. Lower-callout dest `68b8378a47d9eb57ed4b41f35bc2bf4ed6fd01a0694fca28c0a5ea90101fee92` archived prior, **untouched**. PRs 85–112. After PR 112 merge `41f775d64f5b862903d0b1a6e2884232b09e4ec1`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-caption-overlay-encode/2026-09-20/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-caption-overlay-encode/2026-09-20/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine transition-luma encode 2026-09-20

Dated **2026-09-20**. New dated dest `/opt/cursor/artifacts/lesson-spine-transition-luma-encode/2026-09-20/LessonSpine.mp4` sha256 `f631402a6dfbb2ca2218ea9617c7b2af527eb7e88f8df5547dc6584c9ef5a96e`. **Current master dest.** Caption-overlay dest `5b229fee3254426ba8b6dca0c7af23f2270b485b7b62f296b5ae6a31b4d5c61c` archived prior, **untouched**. PRs 85–115. After PR 115 merge `8626a7633167a7018d5eeaa9cceaf6889a39b055`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-transition-luma-encode/2026-09-20/`. Checklist `hold_cleaning: true`. `--flip` refused.

```
verdict: PASS
dated: 2026-09-20
rendering: /opt/cursor/artifacts/lesson-spine-transition-luma-encode/2026-09-20/LessonSpine.mp4
sha256: f631402a6dfbb2ca2218ea9617c7b2af527eb7e88f8df5547dc6584c9ef5a96e
stills: /opt/cursor/artifacts/remotion-lesson-spine-transition-luma-encode/2026-09-20/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine transition-luma master dest reaudit 2026-09-20

Dated **2026-09-20** Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-transition-luma-encode/2026-09-20/LessonSpine.mp4` sha256 `f631402a6dfbb2ca2218ea9617c7b2af527eb7e88f8df5547dc6584c9ef5a96e` plus TransitionLuma plates. After PR 116 merge `e5e46db240fd5251b3e3996da746f50e08697625`. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Caption-overlay dest **untouched** (`5b229fee3254426ba8b6dca0c7af23f2270b485b7b62f296b5ae6a31b4d5c61c`). Locked master dest **untouched**.
...
rendering: /opt/cursor/artifacts/lesson-spine-transition-luma-encode/2026-09-20/LessonSpine.mp4
sha256: f631402a6dfbb2ca2218ea9617c7b2af527eb7e88f8df5547dc6584c9ef5a96e
stills: /opt/cursor/artifacts/remotion-antagonist-transition-luma-master/2026-09-20/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine end-card encode 2026-09-20

Dated **2026-09-20**. New dated dest `/opt/cursor/artifacts/lesson-spine-end-card-encode/2026-09-20/LessonSpine.mp4` sha256 `073e1e3b18f3c6f2bc1590991d5bee4059c33487a19ff083c55927480d7a7693`. Archived prior dest. Transition-luma dest `f631402a6dfbb2ca2218ea9617c7b2af527eb7e88f8df5547dc6584c9ef5a96e` archived prior, **untouched**. PRs 85–118. After PR 118 merge `db636a30e6d47a223101db2154b835e236e451fc`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-end-card-encode/2026-09-20/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
## LessonSpine end-card master dest reaudit 2026-09-20

Dated **2026-09-20** reaudit. Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-end-card-encode/2026-09-20/LessonSpine.mp4` sha256 `073e1e3b18f3c6f2bc1590991d5bee4059c33487a19ff083c55927480d7a7693` plus EndCard plates. After PR 119 merge `9f762bf0fec4a7df1b4cd3370071c8246122c86b`. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Transition-luma dest **untouched** (`f631402a6dfbb2ca2218ea9617c7b2af527eb7e88f8df5547dc6584c9ef5a96e`). Locked master dest **untouched**.
...
rendering: /opt/cursor/artifacts/lesson-spine-end-card-encode/2026-09-20/LessonSpine.mp4
sha256: 073e1e3b18f3c6f2bc1590991d5bee4059c33487a19ff083c55927480d7a7693
stills: /opt/cursor/artifacts/remotion-antagonist-end-card-master/2026-09-20/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine practice encode 2026-09-21

Dated **2026-09-21**. New dated dest `/opt/cursor/artifacts/lesson-spine-practice-encode/2026-09-21/LessonSpine.mp4` sha256 `8c953707401f835551ceec5d96c090b133cd619b41c4b7ff543b1637edc44dbf`. Archived prior dest. End-card dest `073e1e3b18f3c6f2bc1590991d5bee4059c33487a19ff083c55927480d7a7693` archived prior, **untouched**. PRs 85–121. After PR 121 merge `e36897dc5c51a44d7735c4612d3b61b83194bb1d`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-practice-encode/2026-09-21/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-practice-encode/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine key-claim encode 2026-09-21

Dated **2026-09-21**. New dated dest `/opt/cursor/artifacts/lesson-spine-key-claim-encode/2026-09-21/LessonSpine.mp4` sha256 `16f516640c5cac4609862ae2436eb37dd118e56bc6633e3dd10d76290a588606`. Archived prior dest. Practice dest `8c953707401f835551ceec5d96c090b133cd619b41c4b7ff543b1637edc44dbf` archived prior, **untouched**. PRs 85–124. After PR 124 merge `f5dbcb9b14faf58f6399cc7b6523c91aba635752`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-key-claim-encode/2026-09-21/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-key-claim-encode/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine scripture encode 2026-09-21

Dated **2026-09-21**. New dated dest `/opt/cursor/artifacts/lesson-spine-scripture-encode/2026-09-21/LessonSpine.mp4` sha256 `cb3a672da3871428548f2e6ec69da03b9c1d2e425058a1b4b856d928a6e43a79`. Archived prior dest. Key-claim dest `16f516640c5cac4609862ae2436eb37dd118e56bc6633e3dd10d76290a588606` archived prior, **untouched**. PRs 85–127. After PR 127 merge `139e5f9600e167c9222833de7df219bb758f5274`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-scripture-encode/2026-09-21/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-scripture-encode/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine scripture encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-scripture-encode/2026-09-21/LessonSpine.mp4` sha256 `cb3a672da3871428548f2e6ec69da03b9c1d2e425058a1b4b856d928a6e43a79` plus ScriptureCard plates. After PR 128 merge `94c848e53a5c4cfa07e735b3fc24869d5a31ffcb`. **Current master dest.** Key-claim dest `16f516640c5cac4609862ae2436eb37dd118e56bc6633e3dd10d76290a588606` **untouched**. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Locked master dest **untouched**.
...
## LessonSpine compare encode 2026-09-21

Dated **2026-09-21**. New dated dest `/opt/cursor/artifacts/lesson-spine-compare-encode/2026-09-21/LessonSpine.mp4` sha256 `917efdb18684f7307ec63dd576b26f15eea207194ea9a6804d121878ff3f3a5d`. Archived prior dest. Scripture dest `cb3a672da3871428548f2e6ec69da03b9c1d2e425058a1b4b856d928a6e43a79` archived prior, **untouched**. PRs 85–130. After PR 130 merge `0b7eb24d1d53a3e7a8fbe9fd0ebc12efbaca0c8a`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-compare-encode/2026-09-21/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-compare-encode/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine compare encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-compare-encode/2026-09-21/LessonSpine.mp4` sha256 `917efdb18684f7307ec63dd576b26f15eea207194ea9a6804d121878ff3f3a5d` plus CompareBoard plates. After PR 131 merge `3f55e15d454ab69e4d494ff59ddb3e4f320379cd`. **Current master dest.** Scripture dest `cb3a672da3871428548f2e6ec69da03b9c1d2e425058a1b4b856d928a6e43a79` **untouched**. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Locked master dest **untouched**.
...
rendering: /opt/cursor/artifacts/lesson-spine-compare-encode/2026-09-21/LessonSpine.mp4
sha256: 917efdb18684f7307ec63dd576b26f15eea207194ea9a6804d121878ff3f3a5d
stills: /opt/cursor/artifacts/remotion-antagonist-compare-encode-master/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine section encode 2026-09-21

Dated **2026-09-21**. New dated dest `/opt/cursor/artifacts/lesson-spine-section-encode/2026-09-21/LessonSpine.mp4` sha256 `f4bf345d6c0ec8c51941b3bb2d08c71589bc822632d935dc26b6d18c07a631e7`. Archived prior dest. Compare dest `917efdb18684f7307ec63dd576b26f15eea207194ea9a6804d121878ff3f3a5d` archived prior, **untouched**. PRs 85–133. After PR 133 merge `e619df3e64a45b150e4d947fe741b88ba92136e8`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-section-encode/2026-09-21/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
## LessonSpine section encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-section-encode/2026-09-21/LessonSpine.mp4` sha256 `f4bf345d6c0ec8c51941b3bb2d08c71589bc822632d935dc26b6d18c07a631e7` plus SectionTitle plates. After PR 134 merge `03c531830a46db72ab577b1487a55207fdd2ff27`. **Current master dest.** Compare dest `917efdb18684f7307ec63dd576b26f15eea207194ea9a6804d121878ff3f3a5d` **untouched**. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Locked master dest **untouched**.
...
rendering: /opt/cursor/artifacts/lesson-spine-section-encode/2026-09-21/LessonSpine.mp4
sha256: f4bf345d6c0ec8c51941b3bb2d08c71589bc822632d935dc26b6d18c07a631e7
stills: /opt/cursor/artifacts/remotion-antagonist-section-encode-master/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine glossary encode 2026-09-21

Dated **2026-09-21**. New dated dest `/opt/cursor/artifacts/lesson-spine-glossary-encode/2026-09-21/LessonSpine.mp4` sha256 `247890d0529b635d8ad39317825c760fe76fe134274e2149e4ccbe9bcb1af32c`. Archived prior dest. Section dest `f4bf345d6c0ec8c51941b3bb2d08c71589bc822632d935dc26b6d18c07a631e7` archived prior, **untouched**. PRs 85–136. After PR 136 merge `71fb9fd3aa6b4709cee42b1515e06826cd435963`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-glossary-encode/2026-09-21/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-objection-encode/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## ExampleCard 2026-09-21

Dated **2026-09-21** reaudit. ExampleCard soft craft beat. Worked example / show-how on `ExampleCard` (`EXAMPLE_CARD_KICKER = "Example"`; `EXAMPLE_CARD_LINE = "Show the work."`; cream + gold 6px left rail). Craft beat on `ExampleCardDemo`. Sequenced after sting/objective path, after CheckpointCard, before PracticeCard. Wired on DefinitionBoard + RecapCard (after Recap before Quiz). After PR 146 merge `7b57e896bc621123539c617c0960924c10cd0a7d` / tip `6a8fce2958c816e620b13e278029baed15c48d78`. ORDER LOCK intact: Opener/sting → TalkingHead/slate → DefinitionBoard/objective → RecapCard → QuizBumper/next-up → EndCard. PracticeCard after Recap/Quiz path. KeyClaim after sting/objective path. ScriptureCard after sting/objective path, after KeyClaim. CompareBoard after sting/objective path, after ScriptureCard. SectionTitle after sting/objective path, after CompareBoard. GlossaryChip after sting/objective path, after SectionTitle. ObjectionCard after sting/objective path, after GlossaryChip. StingColdOpen on Opener/sting only. CheckpointCard after sting/objective path, after ObjectionCard, before PracticeCard. ExampleCard after sting/objective path, after CheckpointCard, before PracticeCard. Locked master dest `/opt/cursor/artifacts/lesson-spine-checkpoint-encode/2026-09-21/LessonSpine.mp4` sha256 `19e5a19c47f72197bbf726707b839bdf287fd3f0111d105b2161fd694584246a` **Current master dest.** **untouched** (plate-level stills only). Stills `/opt/cursor/artifacts/remotion-example-card/2026-09-21/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
rendering: /opt/cursor/artifacts/lesson-spine-checkpoint-encode/2026-09-21/LessonSpine.mp4
sha256: 19e5a19c47f72197bbf726707b839bdf287fd3f0111d105b2161fd694584246a
stills: /opt/cursor/artifacts/remotion-example-card/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
Stills: `ExampleCardDemo-f0.png`, `ExampleCardDemo-f60.png`, `LessonSpine-recap-f864.png`.

## LessonSpine example encode 2026-09-21

Dated **2026-09-21**. New dated dest `/opt/cursor/artifacts/lesson-spine-example-encode/2026-09-21/LessonSpine.mp4` sha256 `f52ae59972fb4c0945febfa8b3166a217822548f8db6eff3468062fe07c0c33b`. **Current master dest.** Checkpoint dest `19e5a19c47f72197bbf726707b839bdf287fd3f0111d105b2161fd694584246a` archived prior, **untouched**. PRs 85–147. After PR 147 merge `2a0befe6578b2dee3b3359f4c34befdfd65a69e5`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-example-encode/2026-09-21/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-example-encode/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-quote-encode/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine steps encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-steps-encode/2026-09-21/LessonSpine.mp4` sha256 `e0ead459d9505cd612403e8601ab1bfd9ef1acbfc3eba59d3640e19ce621935b` plus StepsCard plates. After PR 154 merge `e7d686228dc64241e368c8e4e6cfc6f80850ce5b`. **Current master dest.** Quote dest `244c485bbfd83e2138c4e499fc07a00f566be3d1ede1c5a3f03dfd57b04feb2d` **untouched**. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Locked master dest **untouched**.
...
rendering: /opt/cursor/artifacts/lesson-spine-steps-encode/2026-09-21/LessonSpine.mp4
sha256: e0ead459d9505cd612403e8601ab1bfd9ef1acbfc3eba59d3640e19ce621935b
stills: /opt/cursor/artifacts/remotion-antagonist-steps-encode-master/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine caveat encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-caveat-encode/2026-09-21/LessonSpine.mp4` sha256 `e23cadde85af2540d3c4f9c8a8434126655133b50c0cdc6c5783b16d9e446fd7` plus CaveatCard plates. After PR 157 merge `5d39d6831f98628df7b0b4ac7e3c9e778cfb4a41`. **Current master dest.** Steps dest `e0ead459d9505cd612403e8601ab1bfd9ef1acbfc3eba59d3640e19ce621935b` **untouched**. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Locked master dest **untouched**.
...
rendering: /opt/cursor/artifacts/lesson-spine-caveat-encode/2026-09-21/LessonSpine.mp4
sha256: e23cadde85af2540d3c4f9c8a8434126655133b50c0cdc6c5783b16d9e446fd7
stills: /opt/cursor/artifacts/remotion-antagonist-caveat-encode-master/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine reflection encode 2026-09-21

Dated **2026-09-21**. New dated dest `/opt/cursor/artifacts/lesson-spine-reflection-encode/2026-09-21/LessonSpine.mp4` sha256 `1e244f82eabceff7e3b16f39d41ff8d49e002aec188c694257f5da9bb4e77f17`. **Current master dest.** Caveat dest `e23cadde85af2540d3c4f9c8a8434126655133b50c0cdc6c5783b16d9e446fd7` archived prior, **untouched**. PRs 85–159. After PR 159 merge `ff30be00fe2f9eab5ff7b9e257b0138990d93f13`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-reflection-encode/2026-09-21/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-reflection-encode/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine timeline encode 2026-09-21

Dated **2026-09-21**. New dated dest `/opt/cursor/artifacts/lesson-spine-timeline-encode/2026-09-21/LessonSpine.mp4` sha256 `2b2dab3e239656e122d4dda3199e294ec836351a83120efaefe2aa54e4b8c068`. **Current master dest.** Reflection dest `1e244f82eabceff7e3b16f39d41ff8d49e002aec188c694257f5da9bb4e77f17` archived prior, **untouched**. PRs 85–162. After PR 162 merge `31791395350e98250526d99b1b27bd8866f55657`. Stills `/opt/cursor/artifacts/remotion-lesson-spine-timeline-encode/2026-09-21/`. Checklist `hold_cleaning: true`. `--flip` refused.
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-timeline-encode/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine source encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-source-encode/2026-09-21/LessonSpine.mp4` sha256 `833d39f430b657e09534b5ddd011e321ce2697f590738001c4c217af6aef1478` plus SourceChip plates. After PR 166 merge `9b7dc9f5ead981bdc6789184f6f51b1ea8f58845`. **Current master dest.** Timeline dest `2b2dab3e239656e122d4dda3199e294ec836351a83120efaefe2aa54e4b8c068` **untouched**. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Locked master dest **untouched**. No encode this round.
...
rendering: /opt/cursor/artifacts/lesson-spine-source-encode/2026-09-21/LessonSpine.mp4
sha256: 833d39f430b657e09534b5ddd011e321ce2697f590738001c4c217af6aef1478
stills: /opt/cursor/artifacts/remotion-antagonist-source-encode-master/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine spectrum encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-spectrum-encode/2026-09-21/LessonSpine.mp4` sha256 `496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0` plus SpectrumBar plates. After PR 169 merge `6b98e60673a3d665fda938c0f8d22896de8d99df`. **Current master dest.** Source dest `833d39f430b657e09534b5ddd011e321ce2697f590738001c4c217af6aef1478` **untouched**. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Locked master dest **untouched**. No encode this round.
...
rendering: /opt/cursor/artifacts/lesson-spine-spectrum-encode/2026-09-21/LessonSpine.mp4
sha256: 496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0
stills: /opt/cursor/artifacts/remotion-antagonist-spectrum-encode-master/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine threshold encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Independent Antagonist v2 against the locked master dest `/opt/cursor/artifacts/lesson-spine-threshold-encode/2026-09-21/LessonSpine.mp4` sha256 `955f0256424fdc4ddb5ae5506a04a9ea877cb6a79ccb126ba1bb4884b9943a6f` plus ThresholdCard plates. After PR 172 merge `e58a798acc98cf307b180234bfa171aaaeecc8f8`. **Current master dest.** Spectrum dest `496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0` **untouched**. ffprobe: h264 1920×1080@30, 41.000s, video only. ORDER LOCK intact. Checklist exit 0, `hold_cleaning: true`, `--flip` refused. Locked master dest **untouched**. No encode this round.
...
rendering: /opt/cursor/artifacts/lesson-spine-threshold-encode/2026-09-21/LessonSpine.mp4
sha256: 955f0256424fdc4ddb5ae5506a04a9ea877cb6a79ccb126ba1bb4884b9943a6f
stills: /opt/cursor/artifacts/remotion-antagonist-threshold-encode-master/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine rubric encode 2026-09-21

Dated **2026-09-21** reaudit. New dated LessonSpine encode bundling RubricCard scoring bands / criteria after ThresholdCard before PracticeCard. After PR 174 merge `80671dd714f2083af06987f65901b5923186d98b` / tip `9001af30693b99fbccbb26ac3bfbc0479d5f7951`. ORDER LOCK intact: Opener/sting → TalkingHead/slate → DefinitionBoard/objective → RecapCard → QuizBumper/next-up → EndCard. PracticeCard after Recap/Quiz path. RubricCard after sting/objective path, after ThresholdCard, before PracticeCard. New dest `/opt/cursor/artifacts/lesson-spine-rubric-encode/2026-09-21/LessonSpine.mp4` sha256 `4aef4c713218247ebb4cad42b637f4b1331a02d6db4fcc13ac13e2bde156a337` **Current master dest.** Threshold dest `955f0256424fdc4ddb5ae5506a04a9ea877cb6a79ccb126ba1bb4884b9943a6f` archived, not overwritten. Spectrum dest `496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0` **untouched**. Checklist `hold_cleaning: true`. `--flip` refused.
...
stills: /opt/cursor/artifacts/remotion-lesson-spine-rubric-encode/2026-09-21/
hold_cleaning: true
auto_flip: false
escalate: false
gates: {
...
## LessonSpine evidence encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Soft Independent Antagonist v2 against locked master dest `/opt/cursor/artifacts/lesson-spine-evidence-encode/2026-09-21/LessonSpine.mp4` sha256 `5d0499f6cbff19149ce0b5da3c615a1ca0ab26fbbece2d9e26da0e78dd367c4b` plus EvidenceCard plates. After PR 178 merge `053c4cee5934b02b25cbe6c2092033d614788c38` / tip `abd17a85cbd2e1cd0af2a14aa59c3d560d757f2c`. ORDER LOCK intact: Opener/sting → TalkingHead/slate → DefinitionBoard/objective → RecapCard → QuizBumper/next-up → EndCard. PracticeCard after Recap/Quiz path. RubricCard after sting/objective path, after ThresholdCard, before PracticeCard. EvidenceCard after sting/objective path, after RubricCard, before PracticeCard. Locked master dest **Current master dest.** **untouched**. Rubric dest `4aef4c713218247ebb4cad42b637f4b1331a02d6db4fcc13ac13e2bde156a337` archived, not overwritten. Threshold dest `955f0256424fdc4ddb5ae5506a04a9ea877cb6a79ccb126ba1bb4884b9943a6f` **untouched**. Spectrum dest `496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0` **untouched**. Checklist `hold_cleaning: true`. `--flip` refused. No encode this round.
...
Stills: `LessonSpine-sting-f42.png`, `LessonSpine-slate-f345.png`, `LessonSpine-objective-f570.png`, `LessonSpine-recap-f864.png`, `LessonSpine-nextup-f1050.png`, `EvidenceCardDemo-f0.png`, `EvidenceCardDemo-f60.png`.

## AnalogyCard 2026-09-21

Dated **2026-09-21** reaudit. AnalogyCard soft craft beat. Analogy / like-this transfer pair distinct from CompareBoard two claims and ExampleCard show-the-work on `AnalogyCard` (`ANALOGY_CARD_KICKER = "Analogy"`; `ANALOGY_CARD_LINE = "Map like this."`; `ANALOGY_CARD_ONE = "Like a seed."`; `ANALOGY_CARD_TWO = "So a type."`; cream + gold 6px left rail; gold transfer chevron). Craft beat on `AnalogyCardDemo`. Sequenced after sting/objective path, after EvidenceCard, before PracticeCard. Wired on DefinitionBoard + RecapCard (after Recap before Quiz). After PR 179 merge `222d4de9061aa3d2e09acea68fba6117b8aed1bd` / tip `5bc002479ad3273fb1c4dbcbdb5379011cb49003`. ORDER LOCK intact: Opener/sting → TalkingHead/slate → DefinitionBoard/objective → RecapCard → QuizBumper/next-up → EndCard. PracticeCard after Recap/Quiz path. RubricCard after sting/objective path, after ThresholdCard, before PracticeCard. EvidenceCard after sting/objective path, after RubricCard, before PracticeCard. AnalogyCard after sting/objective path, after EvidenceCard, before PracticeCard. Locked master dest `/opt/cursor/artifacts/lesson-spine-evidence-encode/2026-09-21/LessonSpine.mp4` sha256 `5d0499f6cbff19149ce0b5da3c615a1ca0ab26fbbece2d9e26da0e78dd367c4b` **Current master dest.** **untouched** (plate-level stills only). Rubric dest `4aef4c713218247ebb4cad42b637f4b1331a02d6db4fcc13ac13e2bde156a337` **untouched**. Threshold dest `955f0256424fdc4ddb5ae5506a04a9ea877cb6a79ccb126ba1bb4884b9943a6f` **untouched**. Spectrum dest `496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0` **untouched**. Checklist `hold_cleaning: true`. `--flip` refused. No encode this round.
...
SOFT notes only: `EDU-S03` olive fixture head (Cap-blocked; no Cap take). `EDU-S01` and `EDU-S02` factory PASS on this dest. AnalogyCard last-word “this.” gold-ticked plus pair “seed.” / “type.” Launch stays CLOSED 0/8.

Stills: `AnalogyCardDemo-f0.png`, `AnalogyCardDemo-f60.png`, `LessonSpine-recap-f864.png`.

## LessonSpine analogy encode 2026-09-21

Dated **2026-09-21** reaudit. New dated LessonSpine encode bundling AnalogyCard analogy / like-this transfer pair after EvidenceCard before PracticeCard. After PR 180 merge `dfca7ff01e40f30b0df77dfca5ac1e0d36fab6ea` / tip `715941bb5c3a9998e7f9f4fea670ffcc7303b256`. ORDER LOCK intact: Opener/sting → TalkingHead/slate → DefinitionBoard/objective → RecapCard → QuizBumper/next-up → EndCard. PracticeCard after Recap/Quiz path. RubricCard after sting/objective path, after ThresholdCard, before PracticeCard. EvidenceCard after sting/objective path, after RubricCard, before PracticeCard. AnalogyCard after sting/objective path, after EvidenceCard, before PracticeCard. New dest `/opt/cursor/artifacts/lesson-spine-analogy-encode/2026-09-21/LessonSpine.mp4` sha256 `a556a0b5a2beaec4b0cc44eadcbf6c092cd152a568282ce3eee06564be01af37` **Current master dest.** Evidence dest `5d0499f6cbff19149ce0b5da3c615a1ca0ab26fbbece2d9e26da0e78dd367c4b` archived, not overwritten. Rubric dest `4aef4c713218247ebb4cad42b637f4b1331a02d6db4fcc13ac13e2bde156a337` **untouched**. Threshold dest `955f0256424fdc4ddb5ae5506a04a9ea877cb6a79ccb126ba1bb4884b9943a6f` **untouched**. Spectrum dest `496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0` **untouched**. Checklist `hold_cleaning: true`. `--flip` refused.
...
SOFT notes only: `EDU-S03` olive fixture head (Cap-blocked; no Cap take). `EDU-S01` and `EDU-S02` factory PASS on this dest. AnalogyCard last-word “this.” gold-ticked. Launch stays CLOSED 0/8.

Stills: `LessonSpine-sting-f42.png`, `LessonSpine-slate-f345.png`, `LessonSpine-objective-f570.png`, `LessonSpine-recap-f864.png`, `LessonSpine-nextup-f1050.png`, `LessonSpine-sting-wipe-f9.png`.

## LessonSpine analogy encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Soft Independent Antagonist v2 against locked master dest `/opt/cursor/artifacts/lesson-spine-analogy-encode/2026-09-21/LessonSpine.mp4` sha256 `a556a0b5a2beaec4b0cc44eadcbf6c092cd152a568282ce3eee06564be01af37` plus AnalogyCard plates. After PR 181 merge `01775d88c1efa63ae97319b281e77aa71204c02d` / tip `dcddaa02945892d964652693bd7edb56f883e40e`. ORDER LOCK intact: Opener/sting → TalkingHead/slate → DefinitionBoard/objective → RecapCard → QuizBumper/next-up → EndCard. PracticeCard after Recap/Quiz path. RubricCard after sting/objective path, after ThresholdCard, before PracticeCard. EvidenceCard after sting/objective path, after RubricCard, before PracticeCard. AnalogyCard after sting/objective path, after EvidenceCard, before PracticeCard. Locked master dest **Current master dest.** **untouched**. Evidence dest `5d0499f6cbff19149ce0b5da3c615a1ca0ab26fbbece2d9e26da0e78dd367c4b` archived, not overwritten. Rubric dest `4aef4c713218247ebb4cad42b637f4b1331a02d6db4fcc13ac13e2bde156a337` **untouched**. Threshold dest `955f0256424fdc4ddb5ae5506a04a9ea877cb6a79ccb126ba1bb4884b9943a6f` **untouched**. Spectrum dest `496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0` **untouched**. Checklist `hold_cleaning: true`. `--flip` refused. No encode this round.
...
Stills: `LessonSpine-sting-f42.png`, `LessonSpine-slate-f345.png`, `LessonSpine-objective-f570.png`, `LessonSpine-recap-f864.png`, `LessonSpine-nextup-f1050.png`, `AnalogyCardDemo-f0.png`, `AnalogyCardDemo-f60.png`.

## CounterexampleCard 2026-09-21

Dated **2026-09-21** reaudit. CounterexampleCard soft craft beat. Counterexample / not-this foil distinct from ExampleCard show-the-work and AnalogyCard like-this transfer on `CounterexampleCard` (`COUNTEREXAMPLE_CARD_KICKER = "Foil"`; `COUNTEREXAMPLE_CARD_LINE = "Name what is not."`; `COUNTEREXAMPLE_CARD_ONE = "Not this case."`; `COUNTEREXAMPLE_CARD_TWO = "A miss."`; cream + gold 6px left rail; gold foil slash / prohibition ring, not AnalogyCard transfer chevron, not ExampleCard show-the-work, not EvidenceCard 8×8 squares). Craft beat on `CounterexampleCardDemo`. Sequenced after sting/objective path, after AnalogyCard, before PracticeCard. Wired on DefinitionBoard + RecapCard (after Recap before Quiz). After PR 182 merge `a464568e7a432ff6d03852170637515dbd4ac952` / tip `4cc07f44d1a2acaa40784950ac56937a2917d520`. ORDER LOCK intact: Opener/sting → TalkingHead/slate → DefinitionBoard/objective → RecapCard → QuizBumper/next-up → EndCard. PracticeCard after Recap/Quiz path. RubricCard after sting/objective path, after ThresholdCard, before PracticeCard. EvidenceCard after sting/objective path, after RubricCard, before PracticeCard. AnalogyCard after sting/objective path, after EvidenceCard, before PracticeCard. CounterexampleCard after sting/objective path, after AnalogyCard, before PracticeCard. Locked master dest `/opt/cursor/artifacts/lesson-spine-analogy-encode/2026-09-21/LessonSpine.mp4` sha256 `a556a0b5a2beaec4b0cc44eadcbf6c092cd152a568282ce3eee06564be01af37` **Current master dest.** **untouched** (plate-level stills only). Evidence dest `5d0499f6cbff19149ce0b5da3c615a1ca0ab26fbbece2d9e26da0e78dd367c4b` **untouched**. Rubric dest `4aef4c713218247ebb4cad42b637f4b1331a02d6db4fcc13ac13e2bde156a337` **untouched**. Threshold dest `955f0256424fdc4ddb5ae5506a04a9ea877cb6a79ccb126ba1bb4884b9943a6f` **untouched**. Spectrum dest `496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0` **untouched**. Checklist `hold_cleaning: true`. `--flip` refused. No encode this round.
...
## LessonSpine counterexample encode master dest reaudit 2026-09-21

Dated **2026-09-21** reaudit. Soft Independent Antagonist v2 against locked master dest `/opt/cursor/artifacts/lesson-spine-counterexample-encode/2026-09-21/LessonSpine.mp4` sha256 `af374d95ee71b4609acae0c76eff7610aa013ee8092cb18051ff511afb220ee4` plus CounterexampleCard plates. After PR 184 merge `7a8f010bd5e65948b55d3067a8262d1652e4975b` / tip `e97a96c34e5831032d36c5b797ad6c4aa0622a99`. ORDER LOCK intact: Opener/sting → TalkingHead/slate → DefinitionBoard/objective → RecapCard → QuizBumper/next-up → EndCard. PracticeCard after Recap/Quiz path. RubricCard after sting/objective path, after ThresholdCard, before PracticeCard. EvidenceCard after sting/objective path, after RubricCard, before PracticeCard. AnalogyCard after sting/objective path, after EvidenceCard, before PracticeCard. CounterexampleCard after sting/objective path, after AnalogyCard, before PracticeCard. Locked master dest **Current master dest.** **untouched**. Analogy dest `a556a0b5a2beaec4b0cc44eadcbf6c092cd152a568282ce3eee06564be01af37` archived, not overwritten. Evidence dest `5d0499f6cbff19149ce0b5da3c615a1ca0ab26fbbece2d9e26da0e78dd367c4b` **untouched**. Rubric dest `4aef4c713218247ebb4cad42b637f4b1331a02d6db4fcc13ac13e2bde156a337` **untouched**. Threshold dest `955f0256424fdc4ddb5ae5506a04a9ea877cb6a79ccb126ba1bb4884b9943a6f` **untouched**. Spectrum dest `496f506babd11a6e5247e87c3bbf926117b0de31feae5b6573fa891bdf6c68d0` **untouched**. Checklist `hold_cleaning: true`. `--flip` refused. No encode this round.
...
Stills: `LessonSpine-sting-f42.png`, `LessonSpine-slate-f345.png`, `LessonSpine-objective-f570.png`, `LessonSpine-recap-f864.png`, `LessonSpine-nextup-f1050.png`, `CounterexampleCardDemo-f0.png`, `CounterexampleCardDemo-f60.png`.

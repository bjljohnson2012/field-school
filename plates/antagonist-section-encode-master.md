# Independent Antagonist v2 — section encode master dest

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-21**. Soft re-score of the locked SectionTitle LessonSpine master plus SectionTitle plates. After PR 134 merge `03c531830a46db72ab577b1487a55207fdd2ff27`. No Cap take.

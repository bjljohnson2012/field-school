# Independent Antagonist v2 — LessonSpine KeyClaim encode

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-21**. New dated LessonSpine encode after PR 124 merge `f5dbcb9b14faf58f6399cc7b6523c91aba635752`. Bundles KeyClaim thesis / claim lock onto the locked PracticeCard master stack. No Cap take. PRs 85–124 harvested.
...
This dest is now an archived prior (file **untouched**). Current master dest is scripture-encode.

# Independent Antagonist v2 — LessonSpine TypeCard + ObjectiveSlate encode

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-20**. New dated LessonSpine encode after PR 98 merge `9e297449738dbe232e3e402aca1760548fc7fce7`. Bundles TypeCard claim last-word ticks + ObjectiveSlate last-word “beat” + DefinitionBoard objective path + locked slate stack. No Cap take. PRs 85–98 harvested.
...
ffprobe: h264 1920×1080@30 duration 41.000s, video only. Sting still gold-ticks “Things” + claim “docked.” + “You will be able to” + `draw one idea per beat`. Slate still gold-ticks “full-bleed” with kicker “Slate” + claim “left.”. Objective still gold-ticks “motion” (DefinitionBoard). Recap still gold-ticks “card” with kicker “Recap”, claim last-words, and returns the same objective. Next-up still shows kicker “Next up” + gold “draw?”. TypeCard cream + gold 6px rail. OverlayLock 30px + seal `1576,24`. Karaoke gold `#C4A35A`. Letterbox ink bars. Head docked. Checklist exit 0. `--flip` refused. Slate dest **untouched** (`d0a09896aa1ea6fc8cf5b5898bc83ddb54faccaa0957c8529a3de0d49a10efc5`). Other priors untouched (`eaf6f84a…` / `cab8bd91…` / `27cc5bf3…` / `9f89f9a9…` / `028d16e4…` / `a5d08284…` / `ec88d257…`).

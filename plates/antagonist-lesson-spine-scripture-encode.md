# Independent Antagonist v2 — LessonSpine ScriptureCard encode

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-21**. New dated LessonSpine encode after PR 127 merge `139e5f9600e167c9222833de7df219bb758f5274`. Bundles ScriptureCard verse / citation lock onto the locked KeyClaim master stack. No Cap take. PRs 85–127 harvested.
...
This dest is now an archived prior (file **untouched**). Current master dest is compare-encode.

...
const DEMO_CAPTIONS: Caption[] = [
  {text: "Watch", startMs: 400, endMs: 800},
  {text: "the", startMs: 800, endMs: 1100},
  {text: "catch.", startMs: 1100, endMs: 2200},
];

/** Isolate the watch-out / warning after Recap before Quiz. LessonSpine length is untouched. */
export const CaveatCardDemo: React.FC = () => {

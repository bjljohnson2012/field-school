...
const DEMO_CAPTIONS: Caption[] = [
  {text: "Think,", startMs: 400, endMs: 800},
  {text: "then", startMs: 800, endMs: 1100},
  {text: "answer.", startMs: 1100, endMs: 2200},
];

/** Isolate the learner pause / think-then-answer after Recap before Quiz. LessonSpine length is untouched. */
export const ReflectionPromptDemo: React.FC = () => {

...
const DEMO_CAPTIONS: Caption[] = [
  {text: "Confirm", startMs: 400, endMs: 900},
  {text: "the", startMs: 900, endMs: 1100},
  {text: "idea.", startMs: 1100, endMs: 2000},
];

/** Isolate the formative check / confirm-understanding after Recap before Quiz. LessonSpine length is untouched. */
export const CheckpointCardDemo: React.FC = () => {

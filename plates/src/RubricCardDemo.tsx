...
const DEMO_CAPTIONS: Caption[] = [
  {text: "Score", startMs: 400, endMs: 800},
  {text: "the", startMs: 800, endMs: 1100},
  {text: "bands.", startMs: 1100, endMs: 2200},
];

/** Isolate the scoring bands / criteria after Recap before Quiz. LessonSpine length is untouched. */
export const RubricCardDemo: React.FC = () => {

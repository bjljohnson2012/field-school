...
const DEMO_CAPTIONS: Caption[] = [
  {text: "Hold", startMs: 400, endMs: 900},
  {text: "the", startMs: 900, endMs: 1100},
  {text: "quote.", startMs: 1100, endMs: 2000},
];

/** Isolate the pull quote / authority cite after Recap before Quiz. LessonSpine length is untouched. */

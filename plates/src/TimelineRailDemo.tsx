...
const DEMO_CAPTIONS: Caption[] = [
  {text: "Mark", startMs: 400, endMs: 800},
  {text: "the", startMs: 800, endMs: 1100},
  {text: "beats.", startMs: 1100, endMs: 2200},
];

/** Isolate the sequence of beats / ordered milestones after Recap before Quiz. LessonSpine length is untouched. */
export const TimelineRailDemo: React.FC = () => {

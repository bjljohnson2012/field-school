...
const DEMO_CAPTIONS: Caption[] = [
  ...
  {text: "cutoff.", startMs: 1100, endMs: 2200},
];

/** Isolate the cutoff / gate mark after Recap before Quiz. LessonSpine length is untouched. */
export const ThresholdCardDemo: React.FC = () => {

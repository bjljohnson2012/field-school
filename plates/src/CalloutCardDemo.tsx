...
const DEMO_CAPTIONS: Caption[] = [
  {text: "Callout", startMs: 400, endMs: 900},
  {text: "names", startMs: 900, endMs: 1200},
  {text: "the", startMs: 1200, endMs: 1400},
  {text: "aside.", startMs: 1400, endMs: 2000},
];

/** Isolate the tip / aside callout after chapter. LessonSpine order is untouched. */
export const CalloutCardDemo: React.FC = () => {

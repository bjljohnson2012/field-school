...
const DEMO_CAPTIONS: Caption[] = [
  ...
  {text: "warrant.", startMs: 1100, endMs: 2200},
];

/** Isolate the evidence / warrant rows after Recap before Quiz. LessonSpine length is untouched. */
export const EvidenceCardDemo: React.FC = () => {

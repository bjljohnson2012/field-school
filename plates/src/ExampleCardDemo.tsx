...
const DEMO_CAPTIONS: Caption[] = [
  {text: "Show", startMs: 400, endMs: 900},
  {text: "the", startMs: 900, endMs: 1100},
  {text: "work.", startMs: 1100, endMs: 2000},
];

/** Isolate the worked example / show-how after Recap before Quiz. LessonSpine length is untouched. */
export const ExampleCardDemo: React.FC = () => {

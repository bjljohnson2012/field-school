...
const DEMO_CAPTIONS: Caption[] = [
  ...
  {text: "source.", startMs: 1100, endMs: 2200},
];

/** Isolate the citation chip distinct from quote / verse after Recap before Quiz. LessonSpine length is untouched. */
export const SourceChipDemo: React.FC = () => {

...
const DEMO_CAPTIONS: Caption[] = [
  ...
  {text: "section.", startMs: 1200, endMs: 2000},
];

/** Isolate the section break / chapter title lock after sting/objective path. LessonSpine length is untouched. */
export const SectionTitleDemo: React.FC = () => {

...
const DEMO_CAPTIONS: Caption[] = [
  ...
  {text: "what", startMs: 800, endMs: 1100},
  {text: "is", startMs: 1100, endMs: 1300},
  {text: "not.", startMs: 1300, endMs: 2200},
];

/** Isolate the counterexample / not-this foil after Recap before Quiz. LessonSpine length is untouched. */
export const CounterexampleCardDemo: React.FC = () => {

...
import {Claim, GoldRule, Kicker, Karaoke, Letterbox, LowerThird, OverlayLock, TalkingHeadCard, Title, TypeCard} from "./layers";
    ...
    <AbsoluteFill style={{backgroundColor: cream}}>
      <Stack>
        ...
        <Layer name="talking-head card">
          <TalkingHeadCard motion="takeover" sceneFrame={frame} />
        </Layer>

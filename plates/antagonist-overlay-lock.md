# Independent Antagonist v2 — OverlayLock

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-20**. OverlayLock soft craft beat. Logo+title lock (`OVERLAY_LOCK_TITLE_PX = 30` + isolated seal at `1576,24` / `80×64`). Craft beat on `OverlayLockDemo`. OverlayLock path only. No Cap take. Plate-level stills only.

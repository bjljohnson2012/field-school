# LessonSpine re-encode with KeyClaim

Locked pedagogical order: Opener/sting → TalkingHead/slate → DefinitionBoard/objective → RecapCard → QuizBumper/next-up.

New dated dest only. Bundles PR 124 KeyClaim thesis / claim lock onto the PracticeCard master stack (PR 85–123). Factory TypeCard + AudioBed + Letterbox + OverlayLock + Karaoke packing + ProgressRail + ChapterChip + LowerThird + CalloutCard + TransitionLuma + EndCard + PracticeCard + KeyClaim. LessonSpine objective beat stays DefinitionBoard. No Cap A-roll.
...
```bash
mkdir -p /opt/cursor/artifacts/lesson-spine-key-claim-encode/2026-09-21
node scripts/render-plate.mjs \
  --comp LessonSpine \
  --dest /opt/cursor/artifacts/lesson-spine-key-claim-encode/2026-09-21/LessonSpine.mp4 \
...
- `--flip` exit 2
- prior dest **files** untouched: practice `8c953707401f835551ceec5d96c090b133cd619b41c4b7ff543b1637edc44dbf` (mtime 2026-09-21 00:06:03Z), end-card `073e1e3b18f3c6f2bc1590991d5bee4059c33487a19ff083c55927480d7a7693` (mtime 2026-09-20 23:45:02Z), transition-luma `f631402a6dfbb2ca2218ea9617c7b2af527eb7e88f8df5547dc6584c9ef5a96e`, caption-overlay `5b229fee…`, lower-callout `68b8378a…`, progress-chapter `a11e31a3…`, typecard-objectiveslate `3f425456…`, slate `d0a09896…`, edu-s02 `eaf6f84a…`, edu-s01 `cab8bd91…`, typecard `27cc5bf3…`, karaoke / audiobed `9f89f9a9…`, letterbox `028d16e4…`, first `a5d08284…`, captions `ec88d257…`

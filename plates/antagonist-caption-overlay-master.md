# Independent Antagonist v2 — caption-overlay master dest

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-20**. Soft re-score of the locked CaptionDensity+OverlayLock LessonSpine master plus CaptionDensity/OverlayLock plates. After PR 113 merge `61e6a76ca7219e2dae7479eb7722e49d2fe53f86`. No Cap take.
...
ffprobe: h264 1920×1080@30 duration 41.000s, video only. Sting gold-ticks “Things” on the packed 6-word line + claim “docked.” + OverlayLock title + seal `1576,24` + LowerThird Teacher/OPENER + CalloutCard Tip “One idea per beat” + ProgressRail sting + ChapterChip “Sting”. Slate kicker “Slate” + gold “full-bleed” + OverlayLock + LowerThird Teacher/OPERATOR + CalloutCard Aside “Head stays docked” + ChapterChip “Slate”. Objective gold-ticks “motion” (DefinitionBoard) + OverlayLock + LowerThird Teacher/DEFINITION + CalloutCard Tip “Type is the lesson” + ChapterChip “Objective”. Recap kicker “Recap” + gold “card” + OverlayLock + LowerThird Teacher/RECAP + CalloutCard Aside “Return the same claim” + ChapterChip “Recap”. Next-up kicker “Next up” + gold “draw?” + OverlayLock + LowerThird Teacher/QUIZ + CalloutCard Tip “Next beat, not a dump” + ChapterChip “Next up”. TypeCard cream + gold 6px rail. OverlayLock 30px + seal `1576,24`. Karaoke gold `#C4A35A` packed 6 words / line. Letterbox. AudioBed unmuted volume 0. Head docked. Checklist exit 0. `--flip` refused. Locked master dest **untouched** (`5b229fee3254426ba8b6dca0c7af23f2270b485b7b62f296b5ae6a31b4d5c61c`). Lower-callout dest **untouched** (`68b8378a47d9eb57ed4b41f35bc2bf4ed6fd01a0694fca28c0a5ea90101fee92`). Other priors untouched (`a11e31a3…` / `3f425456…` / `d0a09896…` / `eaf6f84a…` / `cab8bd91…` / `27cc5bf3…` / `9f89f9a9…` / `028d16e4…` / `a5d08284…` / `ec88d257…`).

Full-set pointer: [antagonist-full-set.md](./antagonist-full-set.md) `## LessonSpine caption-overlay master dest reaudit 2026-09-20`. Encode: [antagonist-lesson-spine-caption-overlay-encode.md](./antagonist-lesson-spine-caption-overlay-encode.md). Plates: [antagonist-caption-density.md](./antagonist-caption-density.md) + [antagonist-overlay-lock.md](./antagonist-overlay-lock.md).

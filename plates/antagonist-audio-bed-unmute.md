# Independent Antagonist v2 — AudioBed unmute

Bar: [../docs/remotion-vox-standards.md](../docs/remotion-vox-standards.md). Do not invent a second bar. Soft notes accepted.

Dated **2026-09-20**. Soft unmute of the silent fixture bed. Craft beat on `AudioBedDemo`. `AUDIO_BED_MUTED=false`, `AUDIO_BED_VOLUME=0`, still `public/audio-bed-silence.wav`. No Cap take. No real Cap A-roll audio. Plate-level stills only.
...
- `RM-H07` — unmuted `<Audio>` on the silent fixture wav, not A-roll / VO
...
No Cap take. No Just remake. No second melt. No live Cleaning / Publish flip. No campus Remotion package. No AUTH_URL / Stripe. No family chrome. No `bc-4765f2f0`. No real Cap A-roll audio. Launch stays CLOSED 0/8.

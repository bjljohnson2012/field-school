...
MEMBERS=(
  ...
  src/lib/billing/hire-activation.ts
  src/app/api/stripe/webhook/route.ts
  src/app/api/billing/hire/route.ts
  ...
  src/lib/progress/supervised-intent.ts
  src/app/api/progress/intent/route.ts
  src/components/fr-3-parent-intent.tsx
  src/app/intent/page.tsx
  src/lib/progress/supervised-path.ts
  src/app/api/progress/path/route.ts
  src/components/fr-4-parent-path.tsx
  src/app/path/page.tsx
  src/lib/progress/supervised-portion.ts
  src/app/api/progress/portion/route.ts
...
mkdir -p \
  ...
  "$STAGE/src/app/intent" \
  "$STAGE/src/app/api/progress/intent" \
  "$STAGE/src/app/path" \
  "$STAGE/src/app/api/progress/path" \
  "$STAGE/src/app/portion" \
  "$STAGE/src/app/api/progress/portion" \
  "$STAGE/src/app/brain" \
  "$STAGE/src/app/api/progress/brain" \
  "$STAGE/src/app/api/composer" \
  "$STAGE/src/app/api/plates" \
  "$STAGE/src/lib/progress" \
  "$STAGE/src/app/api/stripe/webhook" \
  "$STAGE/src/app/api/billing/hire" \
  "$STAGE/src/app/api/checkout/status" \
  "$STAGE/src/app/checkout/success" \
  "$STAGE/src/lib/billing" \

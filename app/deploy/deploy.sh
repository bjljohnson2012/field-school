...
for f in 0001_wave1.sql 0002_field_pattern.sql 0003_pattern_weights.sql 0004_tenants.sql 0005_composer.sql 0006_learning_intents.sql 0007_curriculum_paths.sql 0008_next_portions.sql 0009_progress_ledgers.sql 0010_knowledge_brains.sql; do

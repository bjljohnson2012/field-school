 ...
 * This file lives in the Next app so the production bundle can import it.
 * Authorization is the raw PEXELS_API_KEY. No Bearer prefix is sent.
 * The value stays outside git. Each cached file keeps a photographer attribution sidecar.
 */

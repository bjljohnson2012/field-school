...
export const FP50_ITEMS: InstrumentItem[] = [
  ...
  I(39, "I do the unglamorous part because it is the part that is required.", { structure: 1, duty: 2 }, true),
  I(40, "I draft out loud, then clean it up.", { pace: 1, expression: 2 }),
  I(41, "If no one leads, I will.", { drive: 2, challenge: 1 }, true),
  I(42, "I would rather be liked in the room than be right in the room.", { harmony: 2, challenge: -1 }, true),
  I(43, "I break a big job into named pieces before I touch the first one.", { structure: 2, abstraction: 1 }),
  I(44, "I lose the thread when a lesson keeps going after I have the point.", { pace: 2 }, true),
  ...
  I(47, "I feel off if I skipped a commitment I made to myself.", { duty: 2 }, true),
  I(48, "I learn faster when I have to teach it back in a sentence.", { expression: 2 }, true),

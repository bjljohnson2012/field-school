...
test("overlay-player-rail pack is HTML5 player only", () => {
  ...
  assert.match(list, /src\/lib\/progress\/supervised\.ts/);
  assert.match(list, /src\/app\/api\/progress\/supervised\/route\.ts/);
  assert.match(list, /src\/components\/fr-6-supervised-progress\.tsx/);
  assert.match(list, /src\/app\/progress\/page\.tsx/);
  assert.match(list, /public\/lessons\/hls\/supervised-progress\.json/);
  assert.match(list, /src\/lib\/progress\/supervised-intent\.ts/);
  assert.match(list, /src\/app\/api\/progress\/intent\/route\.ts/);
  assert.match(list, /src\/components\/fr-3-parent-intent\.tsx/);
  assert.match(list, /src\/app\/intent\/page\.tsx/);
  assert.match(list, /public\/lessons\/hls\/supervised-intent\.json/);
  assert.match(list, /src\/lib\/progress\/supervised-path\.ts/);
  assert.match(list, /src\/app\/api\/progress\/path\/route\.ts/);
  assert.match(list, /src\/components\/fr-4-parent-path\.tsx/);
  assert.match(list, /src\/app\/path\/page\.tsx/);
  assert.match(list, /public\/lessons\/hls\/supervised-path\.json/);
  assert.match(list, /src\/lib\/progress\/supervised-portion\.ts/);
  assert.match(list, /src\/app\/api\/progress\/portion\/route\.ts/);
  ...
  assert.match(list, /src\/app\/api\/composer\/route\.ts/);
  assert.match(list, /src\/app\/api\/plates\/route\.ts/);
